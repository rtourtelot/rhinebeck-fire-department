/**
 * This script helps you collect Webflow CDN URLs and create mappings for the imageUtils.ts file
 * It creates a template file that you can fill with your Webflow CDN URLs
 */

const fs = require('fs');
const path = require('path');

// Template for collecting image URLs
...
// Create the file
try {
  const outputPath = path.join(__dirname, 'webflow-urls.md');
  fs.writeFileSync(outputPath, templateContent);
  console.log(`Created webflow-urls.md template in the scripts directory.`);
  console.log(`Open this file and add your Webflow CDN URLs.`);
} catch (error) {
